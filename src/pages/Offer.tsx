          ...
          <div className="prose prose-lg max-w-none" style={{ fontFamily: 'Arial, Helvetica, sans-serif' }}>
            <div className="bg-gray-50 p-6 rounded-lg mb-8">
              <p className="text-gray-600 mb-0">
                Здесь будет размещен текст публичной оферты после предоставления контента.
              </p>
            </div>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">3. Порядок заключения договора</h2>
            <p className="text-gray-700 leading-relaxed mb-6">
              Текст будет добавлен после предоставления контента.
            </p>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">5. Стоимость и порядок оплаты</h2>
            <p className="text-gray-700 leading-relaxed mb-6">
              Текст будет добавлен после предоставления контента.
            </p>
