...
const DemoCallSection = () => {
  ...
  if (isSubmitted) {
    return (
      <section id="demo-call" className="py-16 lg:py-24 bg-gradient-to-br from-primary/5 to-accent/5">
  ...
  return (
    <section id="demo-call" className="py-16 lg:py-24 bg-gradient-to-br from-primary/5 to-accent/5">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div 
          ref={ref}
          className={`text-center mb-12 scroll-fade-in ${isVisible ? 'visible' : ''}`}
        >
